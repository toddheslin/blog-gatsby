...
jQuery(document).ready(function(){function e(){jQuery("pre code").each(function(e){"undefined"!=typeof jQuery(this).attr("data-language")&&jQuery(this).attr("data-language")!==!1||jQuery(this).attr("data-language","javascript")}),config.highlightcode===!0&&Rainbow.color()}function t(){jQuery(".post").fitVids()}function n(){0===jQuery(".pagination .largeoutline").length&&jQuery(".pagination").hide()}function o(){config.show_ecko_disclaimer===!1&&jQuery(".copyright .ecko").hide()}function i(){jQuery(".comments .graybar").show(),(0!==jQuery(".comments").length&&""!==config.disqus_shortname&&null!==config.disqus_shortname&&void 0!==config.disqus_shortname||config.google_comments===!0)&&jQuery(".comments .graybar").show(),jQuery(".comments .graybar").click(function(){a()}),config.autoload_comments===!0&&a()}function a(){if(0!==jQuery(".comments").length&&""!==config.disqus_shortname&&null!==config.disqus_shortname&&void 0!==config.disqus_shortname||config.google_comments===!0)if(""!==config.disqus_shortname){var e=config.disqus_shortname;!function(){var t=document.createElement("script");t.type="text/javascript",t.async=!0,t.src="//"+e+".disqus.com/embed.js",(document.getElementsByTagName("head")[0]||document.getElementsByTagName("body")[0]).appendChild(t)}()}else config.google_comments===!0&&jQuery.getScript("https://apis.google.com/js/plusone.js").done(function(e,t){gapi.comments.render("g-comments",{href:window.location,width:"760",first_party_property:"BLOGGER",view_type:"FILTERED_POSTMOD"})});jQuery(".disqus_thread, #g-comments").show(),jQuery(".comments .graybar").html('<i class="fa fa-comments"></i>Comments')}function s(){""!==config.analytics_id&&null!==config.analytics_id&&void 0!==config.analytics_id&&(!function(e,t,n,o,i,a,s){e.GoogleAnalyticsObject=i,e[i]=e[i]||function(){(e[i].q=e[i].q||[]).push(arguments)},e[i].l=1*new Date,a=t.createElement(n),s=t.getElementsByTagName(n)[0],a.async=1,a.src=o,s.parentNode.insertBefore(a,s)}(window,document,"script","//www.google-analytics.com/analytics.js","ga"),ga("create",config.analytics_id,"auto"),ga("send","pageview"))}function r(){jQuery(".shorttabs").each(function(){jQuery(".shorttabscontent",this).hide(),jQuery(".shorttabscontent",this).first().show(),jQuery(".shorttabsheader",this).first().addClass("active")})}function c(){jQuery(".tags > a:first-of-type").each(function(e){var t=jQuery(this).text();"feature"!=t&&"banner"!=t||0!==jQuery(this).next().length&&(jQuery(this).hide(),jQuery(this).next().show())}),jQuery(".tags a").each(function(e){var t=jQuery(this).text();"feature"!=t&&"banner"!=t||jQuery(this).hide()})}!function(){n(),e(),o(),t(),i(),s(),r(),c()}(),jQuery(".backtotop").click(function(){return jQuery("html, body").animate({scrollTop:0},"slow"),!1}),jQuery(".inlinemenu > .graybar").click(function(){jQuery(".inlinemenu > .menu").toggle()}),jQuery(".shorttoggle .toggleheader").click(function(){jQuery(this).siblings(".togglecontent").toggle()}),jQuery(".shorttabsheader").click(function(){jQuery(".shorttabscontent",jQuery(this).parent()).hide(),jQuery(".shorttabsheader.active",jQuery(this).parent()).removeClass("active"),jQuery(this).addClass("active"),jQuery(".shorttabscontent[data-id='"+jQuery(this).attr("data-id")+"']").show()}),parseTags()});